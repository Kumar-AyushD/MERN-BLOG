      ...
      <div className='max-w-2xl mx-auto p-3 text-center'>
        <div>
          ...
          <div className='text-md text-gray-500 flex flex-col gap-6'>
            <p>
              Welcome to Ayush's Blog! This blog is created by <b>Kumar Ayush </b> 
              as a personal project to share my thoughts and ideas with the
              world. I am a passionate developer who loves
            ...
            <p>
              ...
              languages. I always try to learn and explore new
